"""Tests for ActLinearDiscriminantAnalysis step."""
import numpy as np
import pandas as pd

from .step_test_case import StepTestCase

from iaml.actionables.predictors.classifier.act_linear_discriminant_analysis import (
    ActLinearDiscriminantAnalysis,
)


class TestActLinearDiscriminantAnalysis(StepTestCase):
    ...
    def test_fit_predict_and_proba(self) -> None:
        ...
        y = [0, 1, 0, 1, 1, 0]
        step = ActLinearDiscriminantAnalysis()
