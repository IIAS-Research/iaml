"""Tests for ActRandomSurvivalForest step."""
import numpy as np
import pandas as pd

from .step_test_case import StepTestCase

from iaml.actionables.predictors.survival.act_random_survival_forest import (
    ActRandomSurvivalForest,
)


class TestActRandomSurvivalForest(StepTestCase):
    ...
    def test_fit_sets_model_and_predicts(self) -> None:
        ...
        self.assertEqual(step.model.__class__.__name__, "RandomSurvivalForest")
