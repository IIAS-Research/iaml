"""Tests for ActSurvivalTree step."""
import unittest
...
try:
    ...
    ActSurvivalTree = None
    SKSURV_AVAILABLE = False


@unittest.skipIf(not SKSURV_AVAILABLE, "sksurv dependency is not installed")
class TestActSurvivalTree(StepTestCase):
    ...
    def test_fit_sets_model_and_predicts(self) -> None:
        ...
        self.assertEqual(step.model.__class__.__name__, "SurvivalTree")
