...
class BalancedAccuracyMetric(Metric):
    ...
    [METRIC] Balanced Accuracy
    """
    name = textwrap.dedent('Balanced Accuracy')
    description = textwrap.dedent('''Balanced Accuracy Score is a metric that evaluates a model's 
    ...
    description_long = textwrap.dedent('''Balanced Accuracy Score evaluates how well a predictive 
