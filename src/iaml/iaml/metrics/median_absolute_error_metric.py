...
class MedianAbsoluteErrorMetric(Metric):
    ...
    name= textwrap.dedent("Median Absolute Error")
    description = textwrap.dedent('''Median Absolute Error (MedAE) is a metric used to evaluate the accuracy of a regression model. 
    ...
    description_long = textwrap.dedent('''Median Absolute Error (MedAE) is a metric that helps assess the accuracy of a regression 
