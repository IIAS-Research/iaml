...
class MeanSquaredLogErrorMetric(Metric):
    ...
    description = '''Mean Squared Log Error (MSLE) measures the average of the squared differences 
        between the logarithm of predicted and actual values. It is useful for data with wide-ranging values.'''
    description_long = '''Mean Squared Log Error (MSLE) evaluates a model's accuracy by calculating the 
