...
class ActSVMSVR(Predictor):
    ...
    [STEP] Learn :  SVM Regressor
    """
    name = textwrap.dedent("Learn : SVM Regression")
    description = textwrap.dedent('''SVM Regressor is a machine learning algorithm that models the relationship 
    ...
    description_long = textwrap.dedent('''SVM Regressor is a type of regression algorithm that models the 
