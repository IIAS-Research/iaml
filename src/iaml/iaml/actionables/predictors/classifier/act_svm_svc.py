...
class ActSVMSVC(Predictor):
    ...
    [STEP] Learn :  SVM Classifier
    """
    name = textwrap.dedent("Learn : SVM Classification")
    description = textwrap.dedent('''SVM Classifier is a machine learning algorithm that models the relationship 
    ...
    description_long = textwrap.dedent('''SVM Classifier is a type of classification algorithm that models the 
