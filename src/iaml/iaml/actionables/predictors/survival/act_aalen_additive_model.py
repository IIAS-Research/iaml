...
class ActAalenAdditiveFitter(Predictor):
    ...
    [STEP] Learn : Aalen's Additive Model for Survival Analysis
    """
    name = textwrap.dedent("Learn : AalenAdditiveFitter")
    description = textwrap.dedent('''Aalen's Additive Model is a semi-parametric survival analysis model 
    ...
    description_long = textwrap.dedent('''Aalen's Additive Model is a flexible alternative to the Cox 
